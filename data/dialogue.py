...
class CHINESE(BaseDataModule):
    def __init__(self, args, model=None) -> None:
        super().__init__(args)
        self.processor = processors[self.args.task_name](self.args.data_dir, self.args.use_prompt)     # processor
    ...
    def add_to_argparse(parser):
        ...
        parser.add_argument("--ptune_k", type=int, default=8, help="number of unused tokens in prompt")
        return parser
